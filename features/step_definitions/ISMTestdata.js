...
module.exports = {
    ...
    ActionApprovalBy: ActionApprovalBy, 
    Rating: Rating,
    IssueSourcetype: IssueSourcetype,
    InitialApproverOrg: InitialApproverOrg,
    InitialApprover: InitialApprover,
    InitialApproverUsername: InitialApproverUsername,
    ActionPlanApproverOrg: ActionPlanApproverOrg,
    ActionPlanApprover: ActionPlanApprover,
    ActionPlanApproverUsername: ActionPlanApproverUsername,
    FinalApproverOrg: FinalApproverOrg,
    FinalApprover: FinalApprover,
    FinalApproverUsername: FinalApproverUsername,
    IssueResolutionSummary: IssueResolutionSummary,
    IssueClosureComments: IssueClosureComments,
    ActionTitle: ActionTitle,
    ActionDescription: ActionDescription,
    ActionStartDate: ActionStartDate,
    ActionOwner: ActionOwner,
    ActionOwnerUsername: ActionOwnerUsername,
    Actionworkdone: Actionworkdone,
