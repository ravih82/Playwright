...
Then Fill Risk Assessment Plan with title "Risk Assessment Plan-cucumberFramework-Feb143",and Assessment title as "Risk Assessment Feb143" and other details
When Submit the Risk Assessment form.
...
Then Fill Risk Assessment Task form by selecting "Risk Assessment Plan-cucumberFramework-Feb143",and other details
...
When Access the Risk Assessment "Risk Assessment Feb143" from my task list
...
When Access the Risk Assessment approval task "Risk Assessment Feb143" from my task list
