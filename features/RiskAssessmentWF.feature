...
Then Fill Risk Assessment Plan with title "Risk Assessment Plan-147A",and Assessment title as "Risk Assessment-147A" and other details
...
Then Fill Risk Assessment Task form by selecting "Risk Assessment Plan-147A",and other details
...
When Access the Risk Assessment "Risk Assessment-147A" from my task list
...
When Access the Risk Assessment approval task "Risk Assessment-147A" from my task list
